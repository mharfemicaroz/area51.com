  ...
  <div class="edu-course course-style-3" :class="extraClass">
    <div class="inner">
      <div class="thumbnail">
        <n-link to="/">
          <img
            :src="'/images/course/course-type-02/' + course.image"
            :alt="course.alt"
          />
        </n-link>
        <div class="time-top">
          <span class="duration"><i class="icon-61"></i>{{ course.type }}</span>
        </div>
      </div>
      <div class="content">
        ...
        <div class="course-rating">
          ...
          <span class="rating-count"
            ...
            {{ course.ratingTotal > 1 ? "Ratings" : "Rating" }})</span
          >
        </div>
        <div class="read-more-btn">
          <n-link to="/" class="edu-btn btn-small btn-secondary"
