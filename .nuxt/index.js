...
import nuxt_plugin_plugin_65eb009b from 'nuxt_plugin_plugin_65eb009b' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_pluginserver_41ff7b2a from 'nuxt_plugin_pluginserver_41ff7b2a' // Source: .\\color-mode\\plugin.server.js (mode: 'server')
import nuxt_plugin_pluginclient_7946d0e3 from 'nuxt_plugin_pluginclient_7946d0e3' // Source: .\\color-mode\\plugin.client.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_65eb009b === 'function') {
    await nuxt_plugin_plugin_65eb009b(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_41ff7b2a === 'function') {
    await nuxt_plugin_pluginserver_41ff7b2a(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_7946d0e3 === 'function') {
    await nuxt_plugin_pluginclient_7946d0e3(app.context, inject)
  }
