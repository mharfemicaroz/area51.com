...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/course/CourseTypeSeven.vue?vue&type=template&id=6e58d8e6
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "edu-course course-style-4 course-style-9",
    ...
    attrs: {
      "src": '/images/course/course-type-06/' + _vm.course.image,
      "alt": _vm.course.alt
    }
  })])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"content\">", "</div>", [_vm._ssrNode("<div class=\"course-price\">" + _vm._ssrEscape("$" + _vm._s(_vm.course.currentPrice)) + "</div> "), _vm._ssrNode("<h6 class=\"title\">", "</h6>", [_c('n-link', {
    attrs: {
      "to": "/course/course-details"
    }
  }, [_vm._v(_vm._s(_vm.course.title))])], 1), _vm._ssrNode(" <div class=\"course-rating\"><div class=\"rating\"><i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i></div> <span class=\"rating-count\">" + _vm._ssrEscape("(" + _vm._s(_vm.course.ratingAvarage) + " /" + _vm._s(_vm.course.ratingTotal) + " " + _vm._s(_vm.course.ratingTotal > 1 ? 'Ratings' : 'Rating') + ")") + "</span></div> <p>" + _vm._ssrEscape(_vm._s(_vm.course.excerpt2)) + "</p> <ul class=\"course-meta\"><li><i class=\"icon-24\"></i>" + _vm._ssrEscape(_vm._s(_vm.course.lessons) + " " + _vm._s(_vm.course.lessons > 1 ? 'Lessons' : 'Lesson')) + "</li> <li><i class=\"icon-25\"></i>" + _vm._ssrEscape(_vm._s(_vm.course.students) + " " + _vm._s(_vm.course.students ? 'Students' : 'Student')) + "</li></ul>")], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"hover-content-aside\">", "</div>", [_vm._ssrNode("<div class=\"content\">", "</div>", [_vm._ssrNode("<span class=\"course-level\">" + _vm._ssrEscape(_vm._s(_vm.course.category)) + "</span> "), _vm._ssrNode("<h5 class=\"title\">", "</h5>", [_c('n-link', {
    attrs: {
      "to": "/course/course-details"
    }
  }, [_vm._v(_vm._s(_vm.course.title))])], 1), _vm._ssrNode(" <div class=\"course-rating\"><div class=\"rating\"><i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i></div> <span class=\"rating-count\">" + _vm._ssrEscape("(" + _vm._s(_vm.course.ratingAvarage) + ")") + "</span></div> <ul class=\"course-meta\"><li>" + _vm._ssrEscape(_vm._s(_vm.course.lessons) + " " + _vm._s(_vm.course.lessons > 1 ? 'Lessons' : 'Lesson')) + "</li> <li>" + _vm._ssrEscape(_vm._s(_vm.course.duration)) + "</li> <li>" + _vm._ssrEscape(_vm._s(_vm.course.level)) + "</li></ul> <div class=\"course-feature\"><h6 class=\"title\">What You’ll Learn?</h6> <ul>" + _vm._ssrList(_vm.course.features.slice(0, 3), function (feature, key) {
...
// CONCATENATED MODULE: ./components/course/CourseTypeSeven.vue?vue&type=template&id=6e58d8e6

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/course/CourseTypeSeven.vue?vue&type=script&lang=js
/* harmony default export */ var CourseTypeSevenvue_type_script_lang_js = ({
  props: ['extraClass', 'course']
});
// CONCATENATED MODULE: ./components/course/CourseTypeSeven.vue?vue&type=script&lang=js
 /* harmony default export */ var course_CourseTypeSevenvue_type_script_lang_js = (CourseTypeSevenvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/course/CourseTypeSeven.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  course_CourseTypeSevenvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var CourseTypeSeven = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/course/course-five.vue?vue&type=template&id=7897fdc5
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"edu-course-area course-area-1 section-gap-equal\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row g-5\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-3 order-lg-2\">", "</div>", [_c('CourseSidebarOne')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-lg-9 col-pr--35 order-lg-1\">", "</div>", [_vm._ssrNode("<div class=\"edu-sorting-area\">", "</div>", [_vm._ssrNode("<div class=\"sorting-left\"><h6 class=\"showing-text\">We found <span>" + _vm._ssrEscape(_vm._s(_vm.getItems.length)) + "</span> courses available for you</h6></div> "), _vm._ssrNode("<div class=\"sorting-right\">", "</div>", [_vm._ssrNode("<div class=\"layout-switcher\">", "</div>", [_vm._ssrNode("<label>Grid</label> "), _vm._ssrNode("<ul class=\"switcher-btn\">", "</ul>", [_vm._ssrNode("<li>", "</li>", [_c('n-link', {
    attrs: {
    ...
    staticClass: "icon-54"
  })])], 1)], 2)], 2), _vm._ssrNode(" <div class=\"edu-sorting\"><div class=\"icon\"><i class=\"icon-55\"></i></div> <select class=\"edu-select\"><option>Filters</option> <option>Low To High</option> <option>High Low To</option> <option>Last Viewed</option></select></div>")], 2)], 2), _vm._ssrNode(" "), _vm._l(_vm.getItems, function (course) {
    return _vm._ssrNode("<div class=\"edu-course-six-each-item\">", "</div>", [_c('CourseTypeSeven', {
      attrs: {
        "course": course
      }
    })], 1);
    ...
    attrs: {
      ...
      "records": _vm.courseData.courses.length,
  ...
  })], 1) : _vm._e()], 2)], 2)])]), _vm._ssrNode(" "), _c('FooterOne')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/course/course-five.vue?vue&type=template&id=7897fdc5

// EXTERNAL MODULE: ./data/course.json
var course = __webpack_require__(97);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/course/course-five.vue?vue&type=script&lang=js

/* harmony default export */ var course_fivevue_type_script_lang_js = ({
  components: {
    ...
    CourseTypeSeven: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 157)),
...
// CONCATENATED MODULE: ./pages/course/course-five.vue?vue&type=script&lang=js
 /* harmony default export */ var course_course_fivevue_type_script_lang_js = (course_fivevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/course/course-five.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  course_course_fivevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var course_five = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {HeaderOne: __webpack_require__(32).default,CourseTypeSeven: __webpack_require__(157).default,FooterOne: __webpack_require__(33).default})
...
//# sourceMappingURL=course-five.js.map