...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/course/course-one.vue?vue&type=template&id=6264f9f0
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"edu-course-area course-area-1 gap-tb-text\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"edu-sorting-area\">", "</div>", [_vm._ssrNode("<div class=\"sorting-left\"><h6 class=\"showing-text\">We found <span>" + _vm._ssrEscape(_vm._s(_vm.courses.length)) + "</span> courses available for you</h6></div> "), _vm._ssrNode("<div class=\"sorting-right\">", "</div>", [_vm._ssrNode("<div class=\"layout-switcher\">", "</div>", [_vm._ssrNode("<label>Grid</label> "), _vm._ssrNode("<ul class=\"switcher-btn\">", "</ul>", [_vm._ssrNode("<li>", "</li>", [_c('n-link', {
    staticClass: "active",
    attrs: {
    ...
    staticClass: "icon-54"
  })])], 1)], 2)], 2), _vm._ssrNode(" <div class=\"edu-sorting\"><div class=\"icon\"><i class=\"icon-55\"></i></div> <select class=\"edu-select\"><option>Filters</option> <option>Low To High</option> <option>High Low To</option> <option>Last Viewed</option></select></div>")], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row g-5\">", "</div>", _vm._l(_vm.courses, function (course) {
    return _vm._ssrNode("<div class=\"col-md-6 col-lg-4 col-xl-3\">", "</div>", [_c('CourseTypeOne', {
      attrs: {
        "course": course,
        "extraClass": "course-box-shadow"
      }
    })], 1);
  }), 0), _vm._ssrNode(" <div class=\"load-more-btn\">" + (_vm.defaultNumberOfCourses < _vm.courseData.courses.length ? "<button class=\"edu-btn\">\n                    Load More <i class=\"icon-56\"></i></button>" : "<!---->") + "</div>")], 2)]), _vm._ssrNode(" "), _c('FooterOne')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/course/course-one.vue?vue&type=template&id=6264f9f0

// EXTERNAL MODULE: ./data/course.json
var course = __webpack_require__(97);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/course/course-one.vue?vue&type=script&lang=js

/* harmony default export */ var course_onevue_type_script_lang_js = ({
  components: {
...
// CONCATENATED MODULE: ./pages/course/course-one.vue?vue&type=script&lang=js
 /* harmony default export */ var course_course_onevue_type_script_lang_js = (course_onevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/course/course-one.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  course_course_onevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var course_one = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=course-one.js.map