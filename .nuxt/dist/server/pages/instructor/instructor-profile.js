...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/course/CourseTypeOne.vue?vue&type=template&id=93d46fd4
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "edu-course course-style-1 hover-button-bg-white",
    ...
    attrs: {
      "src": '/images/course/course-type-01/' + _vm.course.image,
      "alt": _vm.course.alt
    }
  })]), _vm._ssrNode(" <div class=\"time-top\"><span class=\"duration\"><i class=\"icon-61\"></i>" + _vm._ssrEscape(_vm._s(_vm.course.duration)) + "</span></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"content\">", "</div>", [_vm._ssrNode("<span class=\"course-level\">" + _vm._ssrEscape(_vm._s(_vm.course.level)) + "</span> "), _vm._ssrNode("<h6 class=\"title\">", "</h6>", [_c('n-link', {
    attrs: {
      "to": "/course/course-details"
    }
  }, [_vm._v(_vm._s(_vm.course.title))])], 1), _vm._ssrNode(" <div class=\"course-rating\"><div class=\"rating\"><i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i></div> <span class=\"rating-count\">" + _vm._ssrEscape("(" + _vm._s(_vm.course.ratingAvarage) + " /" + _vm._s(_vm.course.ratingTotal) + " " + _vm._s(_vm.course.ratingTotal > 1 ? 'Ratings' : 'Rating') + ")") + "</span></div> <div class=\"course-price\">" + _vm._ssrEscape("$" + _vm._s(_vm.course.currentPrice)) + "</div> <ul class=\"course-meta\"><li><i class=\"icon-24\"></i>" + _vm._ssrEscape(_vm._s(_vm.course.lessons) + " " + _vm._s(_vm.course.lessons > 1 ? 'Lessons' : 'Lesson')) + "</li> <li><i class=\"icon-25\"></i>" + _vm._ssrEscape(_vm._s(_vm.course.students) + " " + _vm._s(_vm.course.students ? 'Students' : 'Student')) + "</li></ul>")], 2)], 2), _vm._ssrNode(" <div class=\"course-hover-content-wrapper\"><button class=\"wishlist-btn\"><i class=\"icon-22\"></i></button></div> "), _vm._ssrNode("<div class=\"course-hover-content\">", "</div>", [_vm._ssrNode("<div class=\"content\">", "</div>", [_vm._ssrNode("<button class=\"wishlist-btn\"><i class=\"icon-22\"></i></button> <span class=\"course-level\">" + _vm._ssrEscape(_vm._s(_vm.course.level)) + "</span> "), _vm._ssrNode("<h6 class=\"title\">", "</h6>", [_c('n-link', {
    attrs: {
      "to": "/course/course-details"
    }
  }, [_vm._v(_vm._s(_vm.course.title))])], 1), _vm._ssrNode(" <div class=\"course-rating\"><div class=\"rating\"><i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i></div> <span class=\"rating-count\">" + _vm._ssrEscape("(" + _vm._s(_vm.course.ratingAvarage) + " /" + _vm._s(_vm.course.ratingTotal + _vm.course.ratingTotal > 1 ? 'Ratings' : 'Rating') + ")") + "</span></div> <div class=\"course-price\">" + _vm._ssrEscape("$" + _vm._s(_vm.course.currentPrice)) + "</div> <p>" + _vm._ssrEscape(_vm._s(_vm.course.excerpt)) + "</p> <ul class=\"course-meta\"><li><i class=\"icon-24\"></i>" + _vm._ssrEscape(_vm._s(_vm.course.lessons + _vm.course.lessons > 1 ? 'Lessons' : 'Lesson')) + "</li> <li><i class=\"icon-25\"></i>" + _vm._ssrEscape(_vm._s(_vm.course.students + _vm.course.students ? 'Students' : 'Student')) + "</li></ul> "), _c('n-link', {
...
// CONCATENATED MODULE: ./components/course/CourseTypeOne.vue?vue&type=template&id=93d46fd4

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/course/CourseTypeOne.vue?vue&type=script&lang=js
/* harmony default export */ var CourseTypeOnevue_type_script_lang_js = ({
  props: ['extraClass', 'course']
});
// CONCATENATED MODULE: ./components/course/CourseTypeOne.vue?vue&type=script&lang=js
 /* harmony default export */ var course_CourseTypeOnevue_type_script_lang_js = (CourseTypeOnevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/course/CourseTypeOne.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  course_CourseTypeOnevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var CourseTypeOne = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/instructor/instructor-profile.vue?vue&type=template&id=027530ca
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  }), _vm._ssrNode(" <div class=\"edu-team-details-area section-gap-equal\"><div class=\"container\"><div class=\"row row--40\"><div class=\"col-lg-4\"><div class=\"team-details-thumb\"><div class=\"thumbnail\"><img src=\"/images/team/team-02/team-07.jpg\" alt=\"team\"></div> <ul class=\"social-share\"><li><a href=\"#\"><i class=\"icon-share-alt\"></i></a></li> <li><a href=\"#\"><i class=\"icon-facebook\"></i></a></li> <li><a href=\"#\"><i class=\"icon-twitter\"></i></a></li> <li><a href=\"#\"><i class=\"icon-linkedin2\"></i></a></li></ul></div></div> <div class=\"col-lg-8\"><div class=\"team-details-content\"><div class=\"main-info\"><span class=\"subtitle\">Instructor</span> <h3 class=\"title\">Edward Narton</h3> <span class=\"designation\">Developer and Teacher</span> <ul class=\"team-meta\"><li><i class=\"icon-25\"></i>20 Students</li> <li><div class=\"rating\"><i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i> <i class=\"icon-23\"></i></div> <span class=\"rating-count\">(720 Rating)</span></li></ul></div> <div class=\"bio-describe\"><h4 class=\"title\">About Me</h4> <p>Lorem ipsum dolor sit amet, consectetur elit sed do eius mod tempor incidid labore dolore magna aliqua. enim ad minim eniam quis nostrud exercitation ullamco laboris nisi aliquip ex commodo consequat. duis aute irure dolor in repreed ut perspiciatis unde omnis iste natus error sit voluptat em acus antium.</p> <p>doloremque laudantium totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi arch itecto beatae vitae dicta sunt explicabo.</p></div> <div class=\"contact-info\"><h4 class=\"title\">Contact Me</h4> <ul><li><span>Address:</span>North Helenavile, FV77 8WS</li> <li><span>Email:</span><a href=\"mailto:edublink@example.com\" target=\"_blank\">edublink@example.com</a></li> <li><span>Phone:</span><a href=\"tel:+37(417)683-4409\">+37 (417) 683-4409</a></li></ul></div></div></div></div></div></div> "), _vm._ssrNode("<div class=\"edu-course-area course-area-1 edu-section-gap bg-lighten01\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_c('SectionTitle', {
    attrs: {
      "title": "My Popular Courses",
      "alignment": "section-center"
    }
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row g-5\">", "</div>", _vm._l(_vm.courseData.courses.slice(0, 8), function (course) {
    return _vm._ssrNode("<div data-aos-delay=\"100\" data-aos=\"fade-up\" data-aos-duration=\"800\" class=\"col-md-6 col-lg-4 col-xl-3\">", "</div>", [_c('CourseTypeOne', {
      attrs: {
        "course": course
      }
    })], 1);
...
// CONCATENATED MODULE: ./pages/instructor/instructor-profile.vue?vue&type=template&id=027530ca

// EXTERNAL MODULE: ./data/course.json
var course = __webpack_require__(97);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/instructor/instructor-profile.vue?vue&type=script&lang=js

/* harmony default export */ var instructor_profilevue_type_script_lang_js = ({
  components: {
    ...
    CourseTypeOne: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 105)),
...
// CONCATENATED MODULE: ./pages/instructor/instructor-profile.vue?vue&type=script&lang=js
 /* harmony default export */ var instructor_instructor_profilevue_type_script_lang_js = (instructor_profilevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/instructor/instructor-profile.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  instructor_instructor_profilevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var instructor_profile = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {HeaderOne: __webpack_require__(32).default,CourseTypeOne: __webpack_require__(105).default,FooterOne: __webpack_require__(33).default})
...
//# sourceMappingURL=instructor-profile.js.map