...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "edu-course course-style-3",
...
// CONCATENATED MODULE: ./components/course/CourseTypeTwo.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  course_CourseTypeTwovue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var CourseTypeTwo = __webpack_exports__["default"] = (component.exports);
...
module.exports.__inject__ = function (context) {
  add("50199167", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Course_vue_vue_type_style_index_0_id_0f126702_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(139);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Course_vue_vue_type_style_index_0_id_0f126702_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Course_vue_vue_type_style_index_0_id_0f126702_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Course_vue_vue_type_style_index_0_id_0f126702_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Course_vue_vue_type_style_index_0_id_0f126702_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/home-university/Course.vue?vue&type=template&id=0f126702
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "edu-course-area course-area-3 section-gap-large bg-lighten04"
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"isotope-wrapper\">", "</div>", [_vm._ssrNode("<div class=\"isotop-button isotop-filter nav\"><button data-bs-toggle=\"pill\" data-bs-target=\"#undergraduate\" role=\"tab\" class=\"nav-link active\">Undergraduate Program</button> <button data-bs-toggle=\"pill\" data-bs-target=\"#graduate\" role=\"tab\" class=\"nav-link\">Graduate Program</button> <button data-bs-toggle=\"pill\" data-bs-target=\"#online\" role=\"tab\" class=\"nav-link\">Online Program</button></div> "), _vm._ssrNode("<div class=\"tab-content\">", "</div>", [_vm._ssrNode("<div id=\"undergraduate\" role=\"tabpanel\" class=\"tab-pane fade show active\">", "</div>", [_vm._ssrNode("<div class=\"row g-5\">", "</div>", _vm._l(_vm.courseData.universityCourses.slice(0, 3), function (course) {
    return _vm._ssrNode("<div class=\"col-md-6 col-lg-4\">", "</div>", [_c('CourseTypeTwo', {
      attrs: {
        "course": course
      }
    })], 1);
  }), 0)]), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"graduate\" role=\"tabpanel\" class=\"tab-pane fade\">", "</div>", [_vm._ssrNode("<div class=\"row g-5\">", "</div>", _vm._l(_vm.courseData.universityCourses.slice(0, 2), function (course) {
    return _vm._ssrNode("<div class=\"col-md-6 col-lg-4\">", "</div>", [_c('CourseTypeTwo', {
      attrs: {
        "course": course
      }
    })], 1);
  }), 0)]), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"online\" role=\"tabpanel\" class=\"tab-pane fade\">", "</div>", [_vm._ssrNode("<div class=\"row g-5\">", "</div>", _vm._l(_vm.courseData.universityCourses.slice(2, 3), function (course) {
    return _vm._ssrNode("<div class=\"col-md-6 col-lg-4\">", "</div>", [_c('CourseTypeTwo', {
      attrs: {
        "course": course
      }
    })], 1);
  }), 0)])], 2)], 2)], 2), _vm._ssrNode(" <ul class=\"shape-group\"><li class=\"shape-1\"><img src=\"/images/others/map-shape-3.png\" alt=\"Shape\"></li> <li class=\"shape-2\"><img src=\"/images/others/map-shape-3.png\" alt=\"Shape\"></li></ul>")], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/home-university/Course.vue?vue&type=template&id=0f126702

// EXTERNAL MODULE: ./data/course.json
var course = __webpack_require__(97);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/home-university/Course.vue?vue&type=script&lang=js
...
/* harmony default export */ var Coursevue_type_script_lang_js = ({
  components: {
    ...
    CourseTypeTwo: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 120))
  },
  data() {
    return {
      courseData: course
...
// CONCATENATED MODULE: ./components/home-university/Course.vue?vue&type=script&lang=js
 /* harmony default export */ var home_university_Coursevue_type_script_lang_js = (Coursevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/home-university/Course.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  home_university_Coursevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
installComponents(component, {CourseTypeTwo: __webpack_require__(120).default})
...
//# sourceMappingURL=home-university-course.js.map